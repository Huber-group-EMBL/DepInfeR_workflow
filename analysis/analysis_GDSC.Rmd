...
result <- runLASSOregression(TargetMatrix = tarMat_GDSC, ViabMatrix = viabMat_GDSC, seed = 333)
...
starMatrix <- starMatrix %>% mutate(Cancer_Type =  factor(Cancer_Type, levels = c("ALL", "LAML","DLBC", "BRCAHer-", "BRCAHer+"))) %>% arrange(Cancer_Type) 
