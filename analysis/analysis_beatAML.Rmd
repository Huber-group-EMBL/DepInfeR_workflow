...
result <- runLASSOregression(TargetMatrix = tarMat_BeatAML , ViabMatrix = viabMat_BeatAML, seed = 333)
...
```{r}
testRes <-  depInfeR::diffImportance(result$coefMat, sample_anno_final)
```
